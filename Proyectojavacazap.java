...
public class Proyectojavacazap {
  ...
  System.out.println( "                  |                Juega y Gana un premio             |                        "     );
  System.out.println("-----------------------------------------------------------------------------------------------------");
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if(valor==numero){
        System.out.println("Felicitaciones, GANASTES con "+contador+" intentos y ganaste un viaje en helicoptero ");
        ganar=true;
...
System.out.println("──────────────────────────█");
        ...
        //Este fue el while que cree
           ...
           (contador<10 && ganar==false);//cerramos el ciclo 'do'
   //'contador<6' y muestra el numero de oportunidades que tiene el jugador que ingresa
   if(ganar==false){
